...
public class MycampaignAdapter extends  RecyclerView.Adapter<MycampaignAdapter.Mycampaignsholder> {

    public MycampaignAdapter(List<campaignClass> campaignClasses) {
        this.campaignClasses = campaignClasses;
    }

    private List<campaignClass> campaignClasses = new ArrayList<>();
    private MycampaignAdapter.OnItemClicked onClick;
    Context context;

    public MycampaignAdapter(List<campaignClass> campaignClasses, gigsAdapter.OnItemClicked onClick) {
        this.campaignClasses = campaignClasses;
    ...
    @NonNull
    @Override
    public MycampaignAdapter.Mycampaignsholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.campaignlist, parent, false);
        return new MycampaignAdapter.Mycampaignsholder(itemview);
    }

    @Override
    public void onBindViewHolder(@NonNull MycampaignAdapter.Mycampaignsholder holder, int position) {
...
//        holder.description.setText(String.valueOf(currentnote.getDescription()));
    ...
    public class Mycampaignsholder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MycampaignAdapter(@NonNull View itemView) {
            super(itemView);
